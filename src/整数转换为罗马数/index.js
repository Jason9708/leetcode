...
·   一般情况下 数字组成：大的数字位+小的数字位 
        ...
        可知：数值大小 == 大的数字位+小的数字位
        再如：1:I  2:II  3: III
·   但当罗马数字进位值（个、十、百、千）== 9 或 == 4 时，数字组成变为：小的数字+大的数字 
·   可知：数值大小 == 大的数字位-小的数字位
...
·   由以上可知一个阿拉伯数字 => 罗马数字 ：num => num/1000 + (num%1000)/100 +(num%100)/10 + num%10
*/
...
var intToRoman = function(num) {
    var Q = ["", "M", "MM", "MMM"]; // 千位
    var B = ["", "C", "CC", "CCC", "CD", "D", "DC", "DCC", "DCCC", "CM"]; // 拜位
    var S = ["", "X", "XX", "XXX", "XL", "L", "LX", "LXX", "LXXX", "XC"]; // 十位
    var G = ["", "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX"]; // 个位
